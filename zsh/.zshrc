...
# As git was installed through Homebrew, it also installed the completion with which overrides Zsh's one and also hub's one
# removing the symlink will make Zsh's completion to be used instead
# See https://stackoverflow.com/a/65842518
